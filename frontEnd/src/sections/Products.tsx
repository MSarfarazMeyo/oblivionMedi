    ...
    const products: Product[] = [
        {
            image: Verbyo,
            name: 'Verbyo',
            description: 'The first organic distribution social media app, where people can earn extra money by posting cool stuff on their social media profiles.',
            cta: 'Contact Us'
        },
        {
            image: Legacy,
            name: 'Digital Legacy',
            description: 'Pass your personality, appearance, knowledge, ideas, and memories to your beloved ones, fostering a continuous interaction with your being.',
            cta: 'Contact Us'
        },
        {
            image: Lopo,
            name: 'LopoApp',
            description: 'Join the content creation contests and win amazing prizes, offered by the advertisers. Easy to join, easy to create, easy to win.',
            cta: 'Contact Us'
        }
    ];
    ...
    return (
        <section className=" py-0 lg:py-20 max-w-6xl flex flex-col ">
            ...
            <div className="w-[321px] mx-auto lg:w-full lg:mx-0 mb-16 ">
                ...
                <p className="text-[18px] leading-[26px] text-[#151439]/80 font-normal w-[321px] mx-auto lg:mx-0 lg:w-[80%] text-center lg:text-left">
                    At Oblivion, we take pride in creating innovative smart digital products. If you're using one of our products and need further assistance beyond our support team, you can <strong className="text-gray-900">submit an appeal, file a complaint, or offer a suggestion here</strong>. Simply select the app and press "Contact" to reach out.
                </p>
            </div>
